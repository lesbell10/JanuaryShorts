...
function updatePlayerInfo() {
    ...
    message.style.display = "none"
        ...
        if (selectedPlayer === "1") {
            ...
            title.innerHTML = "NHL BEST PLAYERS<br>1995–2000 (3 TEAMS)";
        ...
        if (selectedPlayer === "3") {
            ...
            FL.textContent = "Yzerman";
            FC.textContent = "Messier";
            FR.textContent = "P Bure";
        
            DL.textContent = "Stevens";
            DR.textContent = "Blake";
